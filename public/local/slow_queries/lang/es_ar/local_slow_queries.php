...
$string['col_origin'] = 'Rastreo de pila';
...
$string['detail_indexes_notice'] = 'Las sugerencias son heurísticas. Pruebe con cuidado en un entorno de pruebas y valide con EXPLAIN/ANALYZE.';
...
$string['logslow_warning_body'] = 'Esta página lee de <code>mdl_log_queries</code>, pero su sitio no está configurado para registrar consultas SQL lentas. Habilite <code>logslow</code> en <code>config.php</code> (establezca <code>true</code> o un número en segundos). Ejemplo:';
$string['logslow_warning_current'] = 'Valor actual';
$string['logslow_warning_hint'] = 'Después de guardar <code>config.php</code>, reproduzca la página/tarea cron lenta y luego actualice esta página para ver nuevas entradas.';
