...
$string['col_avgtime'] = 'Tiempo prom. (s)';
$string['col_count'] = 'Conteo';
$string['col_cron'] = 'CRON';
$string['col_origin'] = 'Rastro de llamadas';
...
$string['detail_indexes_notice'] = 'Las sugerencias son heurísticas. Prueba con cuidado en un entorno de staging y valida con EXPLAIN/ANALYZE.';
$string['detail_sql'] = 'SQL y parámetros';
$string['detail_sql_expanded'] = 'SQL con parámetros';
$string['detail_sql_expanded_desc'] = 'Expansión de mejor esfuerzo para análisis (solo visualización)';
...
$string['logslow_warning_body'] = 'Esta página lee desde <code>mdl_log_queries</code>, pero tu sitio no está configurado para registrar consultas SQL lentas. Habilita <code>logslow</code> en <code>config.php</code> (configúralo en <code>true</code> o en un número en segundos). Ejemplo:';
$string['logslow_warning_current'] = 'Valor actual';
$string['logslow_warning_hint'] = 'Después de guardar <code>config.php</code>, reproduce la página/tarea de cron lenta y luego actualiza esta página para ver nuevas entradas.';
...
$string['privacy:metadata'] = 'El plugin Consultas lentas no almacena datos personales. Solo muestra a los administradores registros existentes del log de consultas de la base de datos.';
...
$string['timeline_totaltime'] = 'En total, la base de datos pasó <strong>{$a}</strong> ejecutando estas sentencias SQL';
