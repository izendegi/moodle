...
$string['dbhost_desc'] = 'Database server IP address or host name. Use a system Data Source Name (DSN) if using Open Database Connectivity (ODBC). Use a PHP Data Objects (PDO) DSN if using PDO.';
