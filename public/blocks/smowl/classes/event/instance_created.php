...
class instance_created extends \core\event\base {
     ...
     * @return object
     */
    public static function create_instance($contextid, $blockinstance) {
    ...
    public static function get_name() {
        return \get_string('eventinstancecreated', 'block_smowl');
    }
    ...
    public function get_description() {
        return \get_string('createblockinstance', 'block_smowl').$this->other['blockinstance'];
    }
