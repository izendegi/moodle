 ...
 *
 * @module      format_muonline/course_mod_modal
...
define(["jquery", "core/modal", "core/config", "core/templates", "core/notification", "core/ajax",
    ...
    function ($, coreModal, config, Templates, Notification, ajax, Fragment, ModalEvents) {
        "use strict";
            ...
            coreModal.create({
                ...
                if (objectType === 'page') {
                    ...
                    Fragment.loadFragment(
                        'format_muonline', `get_cm_content`, moduleContextId, {contextid: moduleContextId}
                    )
                    ...
                    if (objectType === "html") {
                        ...
                        template = 'format_muonline/embed_file_modal_body';
                        ...
                        template = 'format_muonline/embed_url_modal_body';
                    }
                ...
                Templates.render("format_muonline/embed_module_modal_header_btns", headerTemplateData).done(function (html) {
        ...
        const modalRequired = function(cmId, url) {
            if (muonlineConfig.modalallowedmodnames === undefined) {
                return false;
            }
            if (muonlineConfig.modalallowedcmids === undefined) {
                return false;
            }
            if (!(muonlineConfig.modalallowedcmids).includes(cmId)) {
                return false;
            }

            return ((muonlineConfig.modalallowedmodnames).includes('page') && url.startsWith(`${config.wwwroot}/mod/page/view.php`))
                || ((muonlineConfig.modalallowedmodnames).includes('url') && url.startsWith(`${config.wwwroot}/mod/url/view.php`))
                || ((muonlineConfig.modalallowedmodnames).includes('pdf') && url.startsWith(`${config.wwwroot}/mod/resource/view.php`))
                || ((muonlineConfig.modalallowedmodnames).includes('html')
        ...
        return {
            init: function (courseIdInit, isEditing, pageType, launchModalCmid, usingJsNav) {
                ...
                $(document).ready(function () {
                    muonlineConfig = $('#format-muonline-js-config').data();
                    const courseIndex = $('nav#courseindex');

                    if (['course-view-muonline', 'section-view-muonline', 'course-view-section-muonline'].includes(pageType)) {
                        // We are on a main muonline page, /course/view.php or /course/section.php in Moodle 4.4+.
                            ...
                            courseIndex.on('click', function(e) {
                                ...
                                if (link && link.data('for') === 'cm_name') {
                                    ...
                                    if (linkUrl) {
                                        ...
                                        ajax.call([{
                                            methodname: "format_muonline_get_course_mod_info", args: {cmid: cmId}
                                            ...
                                            if (modalRequired(cmId, linkUrl)) {
                                                ...
                                                if (usingJsNav) {
                                                    if (expandedSection.length === 0) {
                                                        require(["format_muonline/course"], function (course) {
                        ...
                        if (launchModalCmid) {
                            ajax.call([{
                                methodname: "format_muonline_get_course_mod_info", args: {cmid: launchModalCmid}
                            }])[0].done(function (data) {
                        ...
                        pageContent.on("keydown", `[data-action="launch-muonline-cm-modal"]`, function (e) {
                            const ENTER_KEY = 13;
                        ...
                        pageContent.on("click", `[data-action="launch-muonline-cm-modal"]`, function (e) {
                        ...
                        Templates.render("format_muonline/loading", {})
