...
/**
 * Javascript Module to handle filter buttons which appear above the muonline if used for format_muonline
 *
 * @module      format_muonline/filter_buttons
...
define(["jquery"], function ($) {
    ...
    var Module = {
        ...
        /**
         * The filter buttons at the top of the course can be used to collapse or expand muonline (animated via CSS)
         ...
         */
        unCollapseMuonline: function (tileIds) {
        ...
        /**
         * Collapse all muonline in the course
         */
        collapseAllMuonline: function () {
        ...
        /**
         * Un-collapse all muonline in the present course (animated via CSS) on filter button press
         */
        unCollapseAllMuonline: function () {
            setTimeout(function () {
        ...
        init: function (courseId, storageEnabledLocal) {
            $(document).ready(function () {
                const getSectionsForButtons = function (buttons) {
                    ...
                    buttons.forEach(button => {
                        ...
                        if (button.attr('data-sections')) {
                            ...
                            // We don't have a data sections attribute so find out which muonline have filter-{x} classes instead.
                ...
                if (buttonAlreadyPressed) {
                    ...
                    Module.collapseAllMuonline();
                    setTimeout(function () {
                            Module.unCollapseMuonline(sections);
                    }, 250);
                    Module.setPressedFilterButton(courseId, buttonAlreadyPressed, storageEnabledLocal);
                    } else {
                        Module.unCollapseAllMuonline();
                    }
                } else {
                    $('#filterbutton-all').addClass(ClassNames.SELECTED);
                }
                ...
                // When a filter button is pressed, mark it as selected and hide/unhide the related muonline.
                ...
                pageContent.on("click", Selector.FILTER_BUTTON, function (e) {
                    ...
                    if (buttonId === "all") {
                        // If "All" button is pressed, un-collapse all muonline.
                        Module.collapseAllMuonline();
                        setTimeout(function () {
                            Module.unCollapseAllMuonline();
                        }, 500);
                        ...
                        // A button except 'All' has been pressed, so collapse all muonline then just reveal the ones we want.
