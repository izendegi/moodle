...
/**
 * Javascript Module to handle browser storage for format_muonline for student view.
 ...
 *
 * @module format_muonline/browser_storage
...
define(["jquery", "format_muonline/browser_storage_set_up"], function ($, storageSetUp) {
    "use strict";
    ...
    var localStorageKeyElements = {
        ...
        user: "-user-",
        section: "-sec-",
        userChoicePrefix: "mdl-muonline-userPrefStorage-"
    };

    /**
     * The last visited section number will be stored with a key in the format
     * mdl-muonline-course-[courseid]-lastSecId
