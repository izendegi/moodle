 ...
 *
 * @module format_muonline/browser_storage_set_up
...
define(["jquery"], function ($) {
    ...
    var localStorageKeyElements = {
        userPrefStorage: "mdl-muonline-userPrefStorage",
        user: "-user-"
    };
    ...
    var obtainUserPreference = function () {
        require(["core/str", "core/notification"], function(str, Notification) {
            str.get_strings([
                {key: "datapref", component: "format_muonline"},
                {key: "dataprefquestion", component: "format_muonline"},
                {key: "yes"},
