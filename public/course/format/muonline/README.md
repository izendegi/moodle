# Muonline Course Format

### Author: David Watson http://evolutioncode.uk

This is the "Muonline" course format plugin for Moodle.

## Installation and Use
This plugin should be installed in a sub directory of /course/format/ called muonline
...
- an Administrator will be able to see the plugins settings under Site Administration > Plugins > Course Formats > Muonline

## Branches

At the time of writing (October 2025) the following branches were being maintained:

| Moodle version | Muonline branch    |
|----------------|-----------------|
| 4.5 LTS        | moodle45        |
| 5.0            | moodle50        |
| 5.1            | master/moodle51 |
