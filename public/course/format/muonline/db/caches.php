...
/**
 * format_muonline cache definitions.
 * @see \format_muonline\local\modal_helper::get_modal_allowed_cm_ids()
 * @see \format_muonline\observer::clear_cache_modal_cmids()
 *
...
$definitions = [
    ...
    'modalcmids' => [
        ...
        'invalidationevents' => [
            'format_muonline/modaladminsettingchanged',
        ],
    ],
