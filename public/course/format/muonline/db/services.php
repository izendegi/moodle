...
/**
 * Format muonline web services defintions
 *
...
$functions = [
    'format_muonline_set_image' => [
        'classname' => 'format_muonline\external\external',
    ...
    'format_muonline_log_tile_click' => [
        'classname' => 'format_muonline\external\external',
        ...
        'ajax' => true,
        'loginrequired' => true,
        'capabilities' => '', // Enrolment check, not capability - see format_muonline\external\external.
    ],
    'format_muonline_get_icon_set' => [
        'classname' => 'format_muonline\external\external',
    ...
    'format_muonline_set_session_width' => [
        'classname' => 'format_muonline\external\external',
        'methodname' => 'set_session_width',
        'description' => 'Set session width of muonline window (so that muonline can be shown with correct width on page load',
        'type' => 'write',
        'ajax' => true,
        'loginrequired' => true,
        'capabilities' => '', // Enrolment check, not capability - see format_muonline\external\external.
    ],
    'format_muonline_get_section_information' => [
        'classname' => 'format_muonline\external\external',
    ...
    'format_muonline_get_course_mod_info' => [
        'classname' => 'format_muonline\external\external',
