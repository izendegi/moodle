...
if ($course->format !== 'muonline' || !\format_muonline\local\modal_helper::cm_has_modal($course->id, $cm->id)) {
...
if ($cm->modname === 'resource') {
    ...
    $modifiedurl = !optional_param('noembed', false, PARAM_BOOL)
        ? \format_muonline\local\video_cm::check_modify_embedded_url($redirecturl)
        : null;
