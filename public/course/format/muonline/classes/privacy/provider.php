 ...
 */
namespace format_muonline\privacy;

use core_privacy\local\metadata\collection;

/**
 * Privacy Subsystem implementation for format_muonline
 *
 * @copyright  2018 David Watson {@link http://evolutioncode.uk}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
        ...
        foreach (self::get_prefs_and_defaults() as $prefname => $default) {
            ...
            if (isset($preference)) {
                ...
                \core_privacy\local\request\writer::export_user_preference(
                    ...
                    $prefname,
                    $value,
                    get_string("privacy:metadata:preference:$prefname", 'format_muonline')
                );
            }
        }
    }
    ...
    private static function get_prefs_and_defaults(): array {
        return [
            'format_muonline_stopjsnav' => 0,
            'format_muonline_high_contrast_mode' => 0,
        ];
    }
}
