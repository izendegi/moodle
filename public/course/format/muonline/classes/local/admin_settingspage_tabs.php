...
class admin_settingspage_tabs extends \admin_settingpage {
    ...
    public function output_html() {
        ...
        foreach ($this->get_tabs() as $index => $tab) {
            $data = [
                'name' => str_replace('format_muonline/', '', $tab->name),
            ...
            if ($tab->name === "format_muonline/tab-colours") {
                $data['iscolourstab'] = 1;
            }
        ...
        return $OUTPUT->render_from_template('format_muonline/admin_setting_tabs', $context);
    }
}
