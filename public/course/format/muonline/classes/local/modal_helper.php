...
/**
 * Helper class for dealing with modals class for format_muonline.
...
class modal_helper {
    ...
    public static function allowed_modal_modules(): array {
        ...
        if (
            ...
            $resources = get_config('format_muonline', 'modalresources');
            $modules = get_config('format_muonline', 'modalmodules');
            return [
    ...
    public static function get_modal_allowed_cm_ids(int $courseid, bool $excludeunavailable): object {
        ...
        $cache = \cache::make('format_muonline', 'modalcmids');
    ...
    public static function clear_cache_modal_cmids(int $courseid, string $modulename = ''): bool {
        // See also \cache_helper::purge_by_event('format_muonline/modaladminsettingchanged') in settings.php.
        $cache = \cache::make('format_muonline', 'modalcmids');
        switch ($modulename) {
            case 'resource':
