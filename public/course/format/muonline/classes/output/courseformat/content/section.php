...
namespace format_muonline\output\courseformat\content;
...
class section extends section_base {
    ...
    public function export_for_template(\renderer_base $output): \stdClass {
        ...
        if (!$data->hasphoto) {
            $data->tileicon = \format_muonline\local\format_option::get(
                $this->section->course,
        ...
        $data->muonlinetyle = get_config('format_muonline', 'muonlinetyle') ?? 1;
