...
namespace format_muonline\output\courseformat\content\section;
...
class controlmenu extends controlmenu_topics {
    ...
    public function section_control_items() {
        ...
        $controls['setphoto'] = new link_secondary(
            ...
            text: get_string('setbackgroundphoto', 'format_muonline'),
            attributes: [
                'class' => 'editing_update', 'data-muonline-action' => 'launch-muonline-icon-picker',
