...
namespace format_muonline\form;
...
class upload_image_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'guidance', get_string('guidance', 'format_muonline'));
        $mform->addElement('html', \html_writer::div(
            get_string('photoguidance_desc', 'format_muonline'),
        ...
        if ($existingphotourl) {
            $mform->addElement('header', 'headertag', get_string('existingimage', 'format_muonline'));
            $formheading = \html_writer::div(
                \html_writer::img(
                    $existingphotourl,
                    get_string('existingimage', 'format_muonline'),
            ...
            $formheading .= \html_writer::div(
                \html_writer::link(
                    ...
                    get_string('deleteimage', 'format_muonline'),
        ...
        $mform->addElement('header', 'uploadnewphotoheader', get_string('uploadnewphoto', 'format_muonline'));

        $mform->addElement(
            'filepicker',
            'tileimagefile',
            get_string('uploadnewphoto', 'format_muonline'),
            null,
            $instance['options']
        );

        $mform->addHelpButton('tileimagefile', 'uploadnewphoto', 'format_muonline');
