...
/**
 * Course format option related unit tests for format muonline
 *
...
/**
 * Class format_muonline_course_format_options_testcase
 * @copyright  2024 David Watson {@link http://evolutioncode.uk}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class format_muonline_course_format_options_test extends \advanced_testcase {
    /**
     ...
     * @covers \format_muonline\local\format_option::migrate_legacy_format_options
     * @return void
    ...
    public function test_course_format_option_migration(): void {
        global $DB, $CFG;
        require_once($CFG->dirroot . '/course/format/muonline/tests/helperlib.php');

        // Create test course old format and migrate it.
        $this->resetAfterTest(true);

        $generator = $this->getDataGenerator();
        $course = $generator->create_course(['format' => 'muonline', 'numsections' => 15]);
     ...
     * @covers \backup_format_muonline_plugin
     * @covers \restore_format_muonline_plugin
        ...
        for ($i = 1; $i <= 5; $i++) {
            ...
            $actualfiles = $DB->get_records_sql(
                "SELECT cs.section, f.filename
                    ...
                    AND f.component = 'format_muonline' AND f.filearea = 'tilephoto'
