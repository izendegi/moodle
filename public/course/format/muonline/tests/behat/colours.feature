@format @format_muonline @format_muonline_colours @javascript
...
Feature: Check that tile colours are correct
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | muonline  | 0             | 7           | 1                |  #1670CC   |
      | Course 2 | C2        | muonline  | 0             | 7           | 1                |  #009681   |
  ...
  Scenario: Student correctly sees green base colour in course 2
    ...
    And format_muonline submuonline are on for course "Course 2"
    And I wait until the page is ready
    And I wait "3" seconds
