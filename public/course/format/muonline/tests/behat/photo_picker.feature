@format @format_muonline @format_muonline_photo_picker @javascript @_file_upload
Feature: Teacher can allocate photos to muonline
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Business Law | BL        | muonline  | 0             | 10          | 1                |
      | Course 2     | C2        | muonline  | 0             | 10          | 1                |
    ...
    And the following config values are set as admin:
      ...
      | allowphotomuonline        | 1        | format_muonline |
  ...
  Scenario: Teacher can use photo picker to pick photos (and icons), and student can view
    ...
    And I upload "course/format/muonline/tests/fixtures/images/placeholder_1.jpg" file to "Upload new photo" filemanager
    ...
    And "Pick a new icon or background photo" "dialogue" should be visible
    And I follow "Upload new photo"
    And I upload "course/format/muonline/tests/fixtures/images/placeholder_3.jpg" file to "Upload new photo" filemanager
    And I press "Save changes"
    And I wait until the page is ready
