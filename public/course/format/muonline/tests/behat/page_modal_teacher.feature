@format @format_muonline @format_muonline_mod_modal @format_muonline_page_modal_teacher @javascript
Feature: Teacher can add a page to a course and open it with submuonline off
  ...
  @javascript
  Scenario: Create and open new page using modal as teacher - submuonline off
...
#    Check that we can see the original page we added
    ...
    And I click format muonline activity "Test page 2"
    And I wait "2" seconds
...
#Now try the same again with sub muonline on
  @javascript
  Scenario: Create and open new page using modal as teacher - submuonline on
    When I am on "Course 1" course homepage with editing mode on
