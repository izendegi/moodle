@format2 @format_muonline @format_muonline_subsection
Feature: Users view subsections on course page in muonline format
  ...
  @javascript
  Scenario: Student can view, expand and collapse subsections on course page with submuonline on
  ...
  @javascript
  Scenario: Student can view, expand and collapse subsections on course page with submuonline off
    When I log in as "student1"
    And I am on "Course 1" course homepage
  ...
  @javascript
  Scenario: Teacher can create activities inside subsections on course page in muonline format
  ...
  @javascript
  Scenario: Teacher can create activities between subsections on course page in muonline format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Teacher can create a subsection at section bottom in muonline format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Teacher can create a subsection between activities in muonline format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
  ...
  @javascript
  Scenario: Teacher can create an activity at section bottom in muonline format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I click on "Add content" "button" in the "General" "section"
    And I wait "1" seconds
  ...
  @javascript
  Scenario: Teacher can create an activity between activities in muonline format
    When I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    And I hover "Insert content before 'New page'" "button"
    And I wait "1" seconds
