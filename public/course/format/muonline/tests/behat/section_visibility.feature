@format @format_muonline @format_muonline_section_vis
Feature: Show/hide course sections in format_muonline
...
# Adapted from core - course/tests/bahat.
  ...
  Scenario: Show / hide section icon functions correctly
    ...
    And I press "Save and return to course"
    And I wait until the page is ready
    And activity in format muonline is dimmed "Test hidden forum 21 name"
    ...
    And I wait until the page is ready
    And I wait "1" seconds
    And activity in format muonline is dimmed "Test hidden forum 31 name"
    And I wait "1" seconds
    And I add a "forum" activity to course "Course 1" section "3"
    And I wait until the page is ready
    And I wait "2" seconds
    ...
    And I wait until the page is ready
    And I wait "1" seconds
    And activity in format muonline is not dimmed "Test hidden forum 31 name"
