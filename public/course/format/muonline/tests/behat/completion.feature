@format @format_muonline @format_muonline_completion @javascript

Feature: Progress indicators can be used to change progress status and changes are reflected in database (without submuonline)
  ...
  Background:
    ...
    And the following config values are set as admin:
      ...
      | muonlinetyle              | 1        | format_muonline |

  @javascript
  Scenario: Log in as student and check/uncheck activities - results correctly reach database
    When I log in as "student1"
    And format_muonline progress indicator is showing as "percent" for course "Course 1"
    And I am on "Course 1" course homepage
    And format_muonline submuonline are off for course "Course 1"
    And I wait "1" seconds
    And format_muonline progress indicator for tile "1" is "0" out of "2"
    And I click on tile "1"
    And I wait until the page is ready

#    And I click format muonline progress indicator for "Test page 1a"
    And I toggle the manual completion state of "Test page 1a"
    And I wait until the page is ready
    Then format_muonline progress for "page" called "Test page 1a" in "Course 1" is "1" in the database
    And I wait until the page is ready
    And format_muonline progress indicator for tile "1" is "1" out of "2"

#    And I click format muonline progress indicator for "Test page 1b"
    And I toggle the manual completion state of "Test page 1b"
    Then format_muonline progress for "page" called "Test page 1b" in "Course 1" is "1" in the database
    And I wait until the page is ready
    And format_muonline progress indicator for tile "1" is "2" out of "2"

#    And I click format muonline progress indicator for "Test page 1a"
    And I toggle the manual completion state of "Test page 1a"
    Then format_muonline progress for "page" called "Test page 1a" in "Course 1" is "0" in the database
    And I wait until the page is ready
    And format_muonline progress indicator for tile "1" is "1" out of "2"

#    And I click format muonline progress indicator for "Test page 1b"
    And I toggle the manual completion state of "Test page 1b"
    Then format_muonline progress for "page" called "Test page 2b" in "Course 1" is "0" in the database
    And I wait until the page is ready
    And format_muonline progress indicator for tile "1" is "0" out of "2"
...
#    And I click format muonline progress indicator for "Test page 1b"
    And I toggle the manual completion state of "Test page 1b"
    Then format_muonline progress for "page" called "Test page 1b" in "Course 1" is "0" in the database
    And format_muonline progress indicator for tile "1" is "0" out of "2"
#
