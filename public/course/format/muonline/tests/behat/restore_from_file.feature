@format @format_muonline @format_muonline_restore_from_file
Feature: Backup and restore of fixture mbz files including images

  Background:
    Given the following "courses" exist:
      | fullname | shortname | category | format |
      | Course 1 | C1        | 0        | muonline  |
  ...
  Scenario: Restore the Moodle 311 mbz file
    ...
    And I upload "course/format/muonline/tests/fixtures/mbz/moodle-311-sample.mbz" file to "Files" filemanager
  ...
  Scenario: Restore the Moodle 43 early beta mbz file
    Given I am on the "Course 1" "restore" page logged in as "admin"
    And I press "Manage course backups"
    And I upload "course/format/muonline/tests/fixtures/mbz/moodle-43-early-beta.mbz" file to "Files" filemanager
    And I press "Save changes"
  ...
  Scenario: Restore the Moodle 43 late beta mbz file
    Given I am on the "Course 1" "restore" page logged in as "admin"
    And I press "Manage course backups"
    And I upload "course/format/muonline/tests/fixtures/mbz/moodle-43-late-beta.mbz" file to "Files" filemanager
    And I press "Save changes"
  ...
  Scenario: Restore the Moodle 42 pre 2024 mbz file
    Given I am on the "Course 1" "restore" page logged in as "admin"
    And I press "Manage course backups"
    And I upload "course/format/muonline/tests/fixtures/mbz/moodle-42-pre-2024.mbz" file to "Files" filemanager
    And I press "Save changes"
