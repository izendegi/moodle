@format_muonline @format_muonline_course_settings
Feature: Edit course settings page format muonline
  In order to set the course according to my teaching needs
  As a teacher
  I need to edit the course settings

#  Quick check that edit course setting page is still working when Muonline in use.
#  The below is copied from course/tests/behat/edit_settings.feature.
  ...
  Scenario: Edit course settings
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1 | <p>Course summary</p> | muonline |
