@format @format_muonline @format_muonline_data_preference @javascript
Feature: user can select whether or not data is stored in browser
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Data Pref Course 1 | C1        | muonline  | 0             | 5           |
      | Data Pref Course 2 | C2        | muonline  | 0             | 5           |
    ...
    And the following config values are set as admin:
      | config                 | value | plugin       |
      | assumedatastoreconsent | 0     | format_muonline |
