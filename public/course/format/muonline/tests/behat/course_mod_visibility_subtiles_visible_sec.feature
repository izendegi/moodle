@format @format_muonline @format_muonline_course_mod_visibility_submuonline_visible_sec  @javascript
Feature: Teacher can hide course modules when submuonline being used in a visible section and this is respected
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course Mod Vis Course4 | C1        | muonline  | 0             | 5           | 1                |
    ...
    And format_muonline submuonline are on for course "Course Mod Vis Course4"

  @javascript
  Scenario: Teacher can see visible (V) and not visible (NV) activities with submuonline on in a visible section
  ...
  @javascript
  Scenario: Student cannot see visible (NV) activities or section with submuonline on in a visible section
