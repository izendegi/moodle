@format @format_muonline @format_muonline_edit_delete_sections @javascript
Feature: Sections can be edited and deleted in muonline format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete muonline
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Edit Delete Secs Course | C1        | muonline  | 0             | 5           |
  ...
  Scenario: View the default name of the second section in muonline format
    And I wait until the page is ready
    And I edit the section "2"
    And I wait until the page is ready
    Then the field "Section name" matches value ""

  Scenario: Edit section default name in muonline format
    And I wait until the page is ready
  ...
  @javascript
  Scenario: Inline edit section name in muonline format
  ...
  Scenario: Deleting the last section in muonline format
    And I wait "1" seconds
  ...
  Scenario: Deleting the middle section in muonline format
    And I wait "1" seconds
  ...
  @javascript
  Scenario: Adding sections in muonline format
#    Increase by 1 tile
#    And I wait "1" seconds
#    And I follow "Add muonline"
#    And I wait until the page is ready
#    And I wait "1" seconds
#    Then the field "Number of sections" matches value "1"
#    And I press "Add muonline"
#    And I should see "Tile 6" in the "li#section-6" "css_element"
#    And "li#section-7" "css_element" should not exist
#todo fix this test - not working as menu item at bottom of course now says add muonline too

#    Increase by 3 more muonline
#    And I follow "Add muonline"
#    And I wait until the page is ready
#    And I wait "1" seconds
