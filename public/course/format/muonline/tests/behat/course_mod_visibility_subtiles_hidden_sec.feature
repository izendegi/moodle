@format @format_muonline @format_muonline_course_mod_visibility_submuonline_hidden_sec @javascript
Feature: Teacher can hide course modules when submuonline being used and this is respected
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course Mod Vis Course3 | C1        | muonline  | 0             | 5           | 1                |
    ...
    And format_muonline submuonline are on for course "Course Mod Vis Course3"
  ...
  @javascript
  Scenario: Teacher hides *whole section* then all activities not visible with submuonline on
  ...
  @javascript
  Scenario: Student cannot see visible (NV) activities or section with submuonline on
