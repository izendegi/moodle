@format @format_muonline @format_muonline_completion_submuonline @javascript
Feature: Progress indicators can be used to change progress status and changes are reflected in database
  ...
  Scenario: Log in as student and check/uncheck activities - results correctly reach database
    ...
    And I click format muonline subtile progress indicator for "Test page 1a"
    ...
    And I click format muonline subtile progress indicator for "Test page 1b"
