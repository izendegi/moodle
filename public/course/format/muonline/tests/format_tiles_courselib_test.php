...
/**
 * Course related tests for format muonline (copied core courselib_test with format changed to muonline).
 *
...
/**
 * Class format_muonline_course_courselib_testcase
 *
 * @copyright 2018 David Watson {@link http://evolutioncode.uk} based on core version 2012 Petr Skoda {@link http://skodak.org}
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class format_muonline_courselib_test extends \advanced_testcase {
    ...
    public function test_create_course_with_generator() {
        global $DB;
        $this->resetAfterTest(true);
        $course = $this->getDataGenerator()->create_course(['format' => 'muonline']);
    ...
    public function test_reorder_sections() {
        ...
        $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'muonline'], ['createsections' => true]);
    ...
    public function test_move_section_marker() {
        ...
        $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'muonline'], ['createsections' => true]);
        $course = $this->getDataGenerator()->create_course(['numsections' => 10, 'format' => 'muonline'], ['createsections' => true]);
    ...
    public function test_course_can_delete_section() {
        ...
        $coursemuonline = $generator->create_course(
            ['numsections' => 5, 'format' => 'muonline'],
            ['createsections' => true]);

        $assign1 = $generator->create_module('assign', ['course' => $coursemuonline, 'section' => 1]);
        $assign2 = $generator->create_module('assign', ['course' => $coursemuonline, 'section' => 2]);
        ...
        $generator->enrol_user($student->id, $coursemuonline->id, $roleids['student']);
        $generator->enrol_user($teacher->id, $coursemuonline->id, $roleids['editingteacher']);

        // Teacher should be able to delete sections (except for 0) in muonline format.
        $this->setUser($teacher);

        // For muonline format will return false for section 0 and true for any other section.
        $this->assertFalse(course_can_delete_section($coursemuonline, 0));
        $this->assertTrue(course_can_delete_section($coursemuonline, 1));
        ...
        $this->assertFalse(course_can_delete_section($coursemuonline, 1));
        $this->assertTrue(course_can_delete_section($coursemuonline, 2));
    ...
    public function test_course_delete_section() {
        ...
        $course = $generator->create_course(['numsections' => 6, 'format' => 'muonline'],
            ['createsections' => true]);
    ...
    public function test_move_module_in_course() {
        ...
        $this->resetAfterTest(true);
        // Setup fixture
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'muonline'], ['createsections' => true]);
    ...
    public function test_section_visibility_events() {
        ...
        $course = $this->getDataGenerator()->create_course(['numsections' => 1, 'format' => 'muonline'], ['createsections' => true]);
        $sectionnumber = 1;
        $forum = $this->getDataGenerator()->create_module('forum', ['course' => $course->id],
    ...
    public function test_course_integrity_check() {
        ...
        $this->resetAfterTest(true);
        $course = $this->getDataGenerator()->create_course(['numsections' => 1, 'format' => 'muonline'],
            ['createsections' => true]);
    ...
    public function test_course_module_create_from_cm() {
        ...
        $course = $this->getDataGenerator()->create_course(['numsections' => 5, 'format' => 'muonline']);
    ...
    public function test_duplicate_module() {
        $this->setAdminUser();
        $this->resetAfterTest();
        $course = self::getDataGenerator()->create_course(['format' => 'muonline']);
    ...
    public function test_course_roles_reset() {
        ...
        $course = $generator->create_course(['format' => 'muonline']);
