...
/**
 * Strings for component 'format_muonline', language 'en', branch 'MOODLE_33_STABLE'
 *
...
$string['allowsubtilesiew_desc'] = 'Allow use of a course setting which, if selected, within a tile shows activities (except labels) as sub tiles, instead of standard list';
...
$string['developedby'] = 'MU Online format, based on: "Tiles" developed by {$a}';
...
$string['tilesectionsubtitle'] = 'Section subtitle';
$string['tilesectionsubtitle_help'] = 'Enter text to appear below the section title on this section tile.';
$string['tilesectionstartdate'] = 'Fecha inicio';
$string['tilesectionstartdate_help'] = 'Selecciona una fecha de inicio para mostrarla en el mosaico de la sección.';
$string['tilesectionenddate'] = 'Fecha fin';
$string['tilesectionenddate_help'] = 'Selecciona una fecha de fin para mostrarla en el mosaico de la sección.';
...
$string['tiles'] = 'Tiles format: not recommended';
